T20 International data in CSV format
====================================

The background
--------------

As an experiment I've been providing IPL data in CSV format for a while now.
Recently someone who has been using that asked whether it would be possible
for the international T20s to also be provided in CSV format and I've
finally had the chance to do the needful.

This zip folder contains the results of the conversion of the YAML data to
CSV, and is loosely based on the format that Retrosheet uses for baseball,
with some suitable hacks built in.
...
case, and have expanded to international T20s now, however I'm open to
expanding if the desire if there.
